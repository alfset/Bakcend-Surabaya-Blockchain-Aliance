...
app.use(cors({
  origin: ['http://localhost:3000', 'https://surabaya-blockchain-alliance-ibc0nzfl6-alfsets-projects.vercel.app', 'https://x.com'],
  credentials: true,
}));
...
app.get('/connect/twitter/callback', async (req, res) => {
    ...
    try {
      ...
      res.redirect('https://surabaya-blockchain-alliance-ibc0nzfl6-alfsets-projects.vercel.app/setup');
    } catch (error) {
